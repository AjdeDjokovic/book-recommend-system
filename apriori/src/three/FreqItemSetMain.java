...
public class FreqItemSetMain {
	public static void main(String[] args) throws Exception {
		...
		String[] forCountRate = {"hdfs://localhost:9000/user/201700301147/apriori2/BX-Book-Ratings.txt","hdfs://localhost:9000/user/201700301147/apriori2/CountRateOutput"};
		CountRate.main(forCountRate);
...
//		String[] forCountRate = {"hdfs://localhost:9000/apriori/BX-Book-Ratings.txt","hdfs://localhost:9000/apriori/CountRateOutput"};
//		CountRate.main(forCountRate);
	}
